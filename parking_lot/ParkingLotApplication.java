...
public class ParkingLotApplication {
    public static void main(String[] args) {
        ...
        //review comments:
        // 1. try to use primitive dataType whenever possible - (read primitive v/s wrapper)
        // 2. try to use protected access specifier when classes in same package & only same package class is using that variable or method.
